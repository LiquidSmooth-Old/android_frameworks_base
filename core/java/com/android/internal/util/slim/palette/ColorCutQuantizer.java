...
import com.android.internal.util.slim.palette.Palette.Swatch;
...
final class ColorCutQuantizer {
    ...
    static ColorCutQuantizer fromBitmap(Bitmap bitmap, int maxColors) {
        ...
        return new ColorCutQuantizer(new com.android.internal.util.slim.palette.ColorHistogram(pixels), maxColors);
    }
     ...
     * @param maxColors The maximum number of colors that should be in the result palette.
     */
    private ColorCutQuantizer(com.android.internal.util.slim.palette.ColorHistogram colorHistogram, int maxColors) {
    ...
    private boolean shouldIgnoreColor(int color) {
        com.android.internal.util.slim.palette.ColorUtils.RGBtoHSL(Color.red(color), Color.green(color), Color.blue(color), mTempHsl);
